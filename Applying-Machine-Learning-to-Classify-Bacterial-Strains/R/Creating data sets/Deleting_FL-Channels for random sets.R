...
this <- "E:/BA/machine learning/accuracy/with_FL/L/t0"
...
Folder      <- "E:/BA/machine learning/accuracy/without_FL/L/t0"   #e.g Bacillus_mKate
...
#function to delete the unneeded columns
f <- function(x,i){ 
  for ( i in 1:n){
    df1 <- delFL(fs[[i]])
    write.csv(df1,paste(Folder,folderlist[i],paste(Filename[i],Ending,suffix, sep="",collapse = NULL, recycle0 = FALSE ), sep="/",collapse = NULL, recycle0 = FALSE ))
...
for (i in 1:nf){
setwd (paste(this,folderlist[i],"/", sep="/",collapse = NULL, recycle0 = FALSE ))
fs <- list.files(path= paste(this,folderlist[i],"/", sep="/",collapse = NULL, recycle0 = FALSE ), pattern = ".csv")
fs <- lapply(fs, read.csv)
dir.create(paste(Folder,folderlist[i],"/", sep="/",collapse = NULL, recycle0 = FALSE ))
setwd(paste(Folder,folderlist[i],"/", sep="/",collapse = NULL, recycle0 = FALSE ))
for (j in 1:n){
    df1 <- delFL(fs[[j]])
    write.csv(df1,paste(Folder,folderlist[j],paste(Filename[j],Ending,suffix, sep="",collapse = NULL, recycle0 = FALSE ), sep="/",collapse = NULL, recycle0 = FALSE ))
  }
}
...
setwd("E:/")
n
setwd (paste(th1s,folderl1st[1],"/", sep="/",collapse = NULL, recycle0 = FALSE ))
fs <- l1st.f1les(path= paste(th1s,folderl1st[1],"/", sep="/",collapse = NULL, recycle0 = FALSE ), pattern = ".csv")
fs <- lapply(fs, read.csv)
d1r.create(paste(Folder,folderl1st[1],"/", sep="/",collapse = NULL, recycle0 = FALSE ))
setwd(paste(Folder,folderl1st[1],"/", sep="/",collapse = NULL, recycle0 = FALSE ))
for (j in 1:n){
  df1 <- delFL(fs[[j]])
  wr1te.csv(df1,paste(Folder,folderl1st[j],paste(F1lename[j],End1ng,suff1x, sep="",collapse = NULL, recycle0 = FALSE ), sep="/",collapse = NULL, recycle0 = FALSE ))
}
